# -*- coding: utf-8 -*-
"""
Created on Tue Nov 12 12:44:32 2019
...
pd.DataFrame({"Parameter": ["ℓ", "η", "σ"],
              "Value at MAP": [float(mp0["ℓ"]), float(mp0["η"]), float(mp0["σ"])],
...
with model:
    pred_samples = pm.sample_posterior_predictive([mp0], vars=[f_pred], samples=1000)
