...
test = flexParams[0]['rv_Connected'];

d = 0;

for t in range(96):
    covTemp = np.vstack((flexParams[d]['rv_Connected'][t], flexParams[d]['rv_Energy'][t], 
                         flexParams[d]['rv_Duration'][t], flexParams[d]['rv_Sparrow'][t]));
